...
const socioPJSchema = z.object({
  ...
  data_registro_junta_comercial: z.date().optional(),
...
type SocioPJFormData = z.infer<typeof socioPJSchema>;

interface SocioPJFormProps {
  personName: string;
  onSubmit: (data: SocioPJFormData) => void;
  onBack?: () => void;
}

export function SocioPJForm({ personName, onSubmit, onBack }: SocioPJFormProps) {
  const form = useForm<SocioPJFormData>({
    resolver: zodResolver(socioPJSchema),
    defaultValues: {},
  });
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                control={form.control}
                name="data_registro_junta_comercial"
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel>Data de Registro na Junta Comercial</FormLabel>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
